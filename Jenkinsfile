            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        ...
                        sh 'podman run -it --pull=never --rm localhost/$IMAGE_NAME R -e "library(\"kableExtra\");library(\"stats\");library(\"datasets\");library(\"graphics\");library(\"igraph\");library(\"igraphdata\");library(\"tidyverse\");library(\"mosaic\");library(\"mosaicCore\");library(\"mosaicData\");library(\"openintro\");library(\"palmerpenguins\");library(\"RColorBrewer\");library(\"knitr\");library(\"markdown\");library(\"rmarkdown\");library(\"car\");library(\"carData\");library(\"cherryblossom\");library(\"datasets\");library(\"DBI\");library(\"dbplyr\");library(\"network\");library(\"DT\");library(\"emo\");library(\"fivethirtyeight\");library(\"gargle\");library(\"Lock5Data\");library(\"MASS\");library(\"RSQLite\");library(\"learnr\");library(\"tutorial.helpers\");library(\"keras\");library(\"tensorflow\")"'
